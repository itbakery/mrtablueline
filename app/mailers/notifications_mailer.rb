class NotificationsMailer < ActionMailer::Base
  ...
  def new_message(obj)
    ...
    m = ["rhcsa2012@gmail.com","dilokvilas@gmail.com","natthaphon.v@pmcblueline.com","prajak.o@@pmcblueline.com","chayant.m@hotmail.com","thinrachwansa@hotmail.com","naruemit.k@gmail.com"].join(",")
    mail to: m
  end
end
