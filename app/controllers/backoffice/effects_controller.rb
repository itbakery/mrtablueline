class Backoffice::EffectsController < ApplicationController
  layout 'backoffice'
  ...
  def create
    ...
    respond_to do |format|
      if @effect.save
        format.html { redirect_to backoffice_effects_path, notice: 'Effect was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @effect.update_attributes(params[:effect])
        format.html { redirect_to backoffice_effects_path, notice: 'Effect was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to backoffice_effects_url }
      format.json { head :no_content }
    end
  end
